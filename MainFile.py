...
import os
root = Tk()
root.title("Обработка фотографий")
...
def switch_pokas():
    ...
    btn10.pack()
    btn10.place(x=1427, y=735)
    btn11.pack()
    btn11.place(x=1150, y=735)
    btn12.pack()
    btn12.place(x=975, y=735)
    btn13.pack()
...
btn3 = Button(text="Нахождение границ(Прюитт)",command=previtt_fun, background="#555", foreground="#ccc", padx="14", pady="7", font="13")
btn3.pack()
btn3.place(x=0, y=680)

btn4 = Button(text="Размытие при помощи медианного значения", command=med_fun,background="#555", foreground="#ccc", padx="14", pady="7", font="13")
btn4.pack()
btn4.place(x=680, y=680)
...
btn6 = Button(text="Размытие по Гауссу", background="#555",command=gauss_fun, foreground="#ccc", padx="30", pady="7", font="13")
btn6.pack()
btn6.place(x=370, y=680)


btn8 = Button(text="+(Г)",command=sigma_change_plus, background="#555", foreground="#ccc", padx="30", pady="7", font="13")
btn8.pack()
btn8.place(x=518, y=735)

btn9 = Button(text="-(Г)",command=sigma_change_minus, background="#555",foreground="#ccc", padx="30", pady="7", font="13")
btn9.pack()
btn9.place(x=370, y=735)

btn10 = Button(text="+(mean)",command=mean_per_change_plus, background="#555", foreground="#ccc", padx="30", pady="7", font="13")
btn10.pack()
btn10.place(x=1427, y=735)

btn11 = Button(text="-(mean)",command=mean_per_change_minus, background="#555",foreground="#ccc", padx="30", pady="7", font="13")
btn11.pack()
btn11.place(x=1150, y=735)

btn12 = Button(text="+(med)",command=men_per_change_plus, background="#555", foreground="#ccc", padx="30", pady="7", font="13")
btn12.pack()
btn12.place(x=975, y=735)

btn13 = Button(text="-(med)",command=men_per_change_minus, background="#555",foreground="#ccc", padx="30", pady="7", font="13")
btn13.pack()
btn13.place(x=680, y=735)
...
btn18 = Button(text="Загрузка фото 1",command=openfn_for_rezim, background="#555",foreground="#ccc", padx="14", pady="7", font="13")
btn18.pack()
btn18.place(x=0, y=350)

btn19 = Button(text="Загрузка фото 2",command=openfn_for_rezim2, background="#555",foreground="#ccc", padx="14", pady="7", font="13")
btn19.pack()
btn19.place(x=900, y=350)

btn20 = Button(text="SIFT",command=shift_fds, background="#555",foreground="#ccc", padx="14", pady="7", font="13")
btn20.pack()
